...
//path= http://localhost:3000/50607080/medic/patients/9800178/newconsultation
...
export default function Consult({ firebase }) {
  ...
  //-------------------------------------------------------------------
  // OJO!!!! Cuando guarde la consulta limpiar las medicinas:   
  ...
  // Esto es para que recargue cuando se actualice medicines al guardar
  // el diálogo (ya que se lo trae del localstorage)
  useEffect(() => {
    if(medicines){
