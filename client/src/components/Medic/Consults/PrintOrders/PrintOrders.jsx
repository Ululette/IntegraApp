...
export default function PrintOrders({ info }) {
  ...
  return (
    <div >
      <Button className={styles.addmed} variant="outlined" size='small' color="primary" onClick={handleClickOpen}>
        Imprimir
      </Button>
      <Dialog className={styles.container} open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        >
          {patient && <DialogContentText >
            ...
            <h1 className={styles.t_center}>Pedido de estudios </h1>
          </DialogContentText>}
          <List>
