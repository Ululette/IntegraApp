...
export default function PartnersAffiliationRequests({ firebase }) {
    ...
    return (
        <div className={classes.root}>
            ...
            >
                <DialogTitle className={classes.popup}>DECLARACION JURADA</DialogTitle>
                <DialogContent >
                    {medicalRecord && <ViewDoc aplication={medicalRecord} />}
                </DialogContent>
                <DialogActions>
                    <Button className={classes.popupBtn}
                            type='close' 
                            onClick={(e) => { e.preventDefault(); setMedicalRecord(null) }}>Cerrar</Button>
                </DialogActions>
            </Dialog>
