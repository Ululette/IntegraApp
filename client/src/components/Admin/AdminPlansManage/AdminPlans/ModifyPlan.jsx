...
export default function ModifyPlan({
  ...
  return (
    ...
    >
      <DialogTitle id="form-dialog-title" className={classes.popup}>MODIFICAR PLAN</DialogTitle>
      <form onSubmit={(e) => handleSubmit(e)}>
        <DialogContent>
          <DialogContentText >Editar los detalles del plan seleccionado.</DialogContentText>
          <TextField
            autoFocus
            margin="dense"
            id="plan-description"
