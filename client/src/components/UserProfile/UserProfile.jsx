...
import { Button, FormControl, Input, TextField, FormHelperText, InputLabel, Select, FilledInput, OutlinedInput } from '@material-ui/core';
  ...
  return (
    <div className="ProfilePage_Cont">
      ...
      {user && <div className="info_cont">
          ...
          <div className="input_info">
            ...
            <div className="on_line_cont">
              <div className="one_info_cont">
                ...
                <p className="profile_info">{user.plans.name}</p>
              </div>
            </div>
            <div className="on_line_cont">
              <div className="one_info_cont">
            ...
            <div className="on_line_cont">
              ...
              <div className="one_info_cont">
                ...
                <p className="profile_info">{user.phone_number}</p>
              </div>
            </div>
            <div className="on_line_cont">
              <div className="one_info_cont">
                <p className="profile_title">Calle:</p>
                <p className="profile_info"> {user.address[0].street}</p>
              </div>
              <div className="one_info_cont">
                <p className="profile_title">Número:</p>
                <p className="profile_info"> {user.address[0].street_number}</p>
              </div>
              <div className="one_info_cont">
                <p className="profile_title">Piso:</p>
                <p className="profile_info"> {user.address[0].floor}</p>
              </div>
              <div className="one_info_cont">
                <p className="profile_title">Dto:</p>
                <p className="profile_info"> {user.address[0].department}</p>
              </div>
            ...
            <div className="on_line_cont">
              <div className="one_info_cont">
                ...
                <p className="profile_info">{user.address[0].localities.name}</p>
              </div>
              <div className="one_info_cont">
                <p className="profile_title">Código Postal:</p>
                <p className="profile_info">{user.address[0].localities.postal_code}</p>
              </div>
            </div>
            <div className="on_line_cont">
              <div className="one_info_cont">
                <p className="profile_title">Provincia:</p>
                <p className="profile_info">{user.address[0].localities.states.name}</p>
              </div>
            </div>
          </div>
          :
          <div className="modif_info">
            <form className="mod_form_cont" noValidate autoComplete="off">
              ...
              <div className="form_left_col">
                <TextField name="street" id="cityInput" className={classes.modInput} label="Calle" 
                defaultValue={modInfo.street} variant="outlined" onChange={handlechange}/>
                <TextField name="street_number" className={classes.modInput} label="Número" 
                defaultValue={modInfo.street_number} variant="outlined" onChange={handlechange}/>
                <TextField name="floor" className={classes.modInput} defaultValue={modInfo.floor} label="Piso" variant="outlined" onChange={handlechange}/>
                <TextField name="department" className={classes.modInput} defaultValue={modInfo.department} label="Departamento" variant="outlined" onChange={handlechange}/>
                <TextField name="email" className={classes.modInput} defaultValue={modInfo.email} label="email" variant="outlined" onChange={handlechange} />
              </div>

              <div className="form_right_col">
                <TextField name="phone" className={classes.modInput}  defaultValue={modInfo.phone}label="Teléfono" variant="outlined" onChange={handlechange}/>

                {/* Verifique por código postal la provincia */}
                <TextField name="state" className={classes.modInput}  defaultValue={modInfo.state}label="Provincia" disabled variant="outlined" />
                ...
                <TextField name="city" className={classes.modInput} value={modInfo.city} disabled label="Ciudad" variant="outlined" />
                <TextField name="postal_code" className={classes.modInput} defaultValue={modInfo.postal_code}  label="Código Postal" variant="outlined" onChange={handlechange}/>
        ...
        <Button variant="contained" className={classes.modButton} onClick={handleclick}>{!modify ? "Modificar" : "Guardar"}</Button>
      </div>}
