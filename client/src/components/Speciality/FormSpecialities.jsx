...
import { getMedicSpecialities,addSpeciality, findSpeciality } from '../../actions/specialities.actions'
    ...
    return (
        <div>
            <TextField size ='small' id="outlined-basic" 
                        label="speciality" variant="outlined"
