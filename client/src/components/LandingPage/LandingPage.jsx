  ...
  return (
    <div className={styles.all}>
      ...
      <div className={styles.info}>
        <p className={styles.des}>Urgencias y emergencias - 0810-454-999 </p>
      ...
      <div className={styles.app}>
        <h2>
          Integra mobile</h2>
          <p className = {styles.desM}>Toda la información que necesitas en un solo lugar</p>
        <div className={styles.images}>
          <img className = {styles.deco}
      ...
      <div className={styles.digital}>
        ...
        <p className = {styles.desC}>La credencial va siempre con vos y sin ocupar lugar en tu billetera</p>
        <p className = {styles.desC}>Todas las credenciales de tu grupo familiaren un solo lugar</p>
      </div>
    </div>
  );
}
